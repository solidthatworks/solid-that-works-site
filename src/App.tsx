...
import { Instagram, ShoppingBag, Music } from "lucide-react";
import {
  Card,
  CardContent,
  CardHeader,
...
const CONFIG = {
  banners: {
    ...
    // You can replace these with images later, e.g.:
    // sectionBg: "url('/your-image.jpg') center/cover no-repeat",
    // footerBg: "url('/your-footer-image.jpg') center/cover no-repeat",
  },
  brand: {
...
function Quote() {
  ...
  function onSubmit(e) {
    e.preventDefault();
    // This demo form does not send anywhere.
    // Hook it up to a form backend (Formspree, Basin, etc.) or your own API.
    setStatus("sent");
...
// BRANDING: fonts + colors applied globally
// Colors: green #00bf63, black #000000, white #ffffff
// Fonts: Titles = ABeeZee, Body = Garet

function SolidThatWorksSite() {
  return (
